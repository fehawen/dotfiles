...
call NERDTreeHighlightFile("jpg",              s:gui.yellow,      s:gui.none)
call NERDTreeHighlightFile("png",              s:gui.yellow,      s:gui.none)
call NERDTreeHighlightFile("svg",              s:gui.yellow,      s:gui.none)
