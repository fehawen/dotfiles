...
let g:colors_name = "ezra"

let s:gui = {}
let s:cterm = {}

let s:gui.background = { 'default': '#263238' }
let s:gui.foreground = { 'default': '#A3A39F' }
...
let s:gui.red        = { 'default': '#AC6B60' }
let s:gui.green      = { 'default': '#758B6E' }
let s:gui.yellow     = { 'default': '#A1876F' }
let s:gui.blue       = { 'default': '#607A89' }
let s:gui.magenta    = { 'default': '#837796' }
let s:gui.cyan       = { 'default': '#809EB2' }
...
call s:hi("NERDTreeDirSlash",   s:gui.comment,    s:gui.none,     "")
...
call s:hi("WarningMsg",   s:gui.red,        s:gui.none,       "")
...
call s:hi("MatchParen",   s:gui.background, s:gui.linelight,  "")
...
call s:hi("Visual",       s:gui.background, s:gui.linelight,  "")
call s:hi("Constant",     s:gui.blue,       "",               "")
call s:hi("Boolean",      s:gui.yellow,     "",               "")
...
call s:hi("Search",       s:gui.background, s:gui.line,       "")
call s:hi("InSearch",     s:gui.background, s:gui.line,       "")
