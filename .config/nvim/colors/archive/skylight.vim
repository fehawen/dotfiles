...
let s:style = get(g:, "skylight_style", "default")
let g:colors_name = "skylight"

let s:gui = {}
let s:cterm = {}

let s:gui.none       = { "default": "NONE" }
let s:gui.foreground = { "default": "#D7D7D7" }
let s:gui.background = { "default": "#000000" }

let s:gui.cursorline = { "default": "#202020" }
let s:gui.listchars  = { "default": "#2D2D2D" }
let s:gui.comment    = { "default": "#373737" }
let s:gui.search     = { "default": "#7F7F7F" }
let s:gui.selection  = { "default": "#B7B7B7" }

let s:gui.black      = { "default": "#373737" }
