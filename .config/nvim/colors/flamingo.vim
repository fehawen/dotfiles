...
let s:palette.dim         = {'default': "#B8B5B3"}
let s:palette.guide       = {'default': "#315967"}
let s:palette.comment     = {'default': "#4C7C8F"}
...
exe "hi! CursorColumn"  .s:fg_none        .s:bg_guide       .s:fmt_none
exe "hi! CursorLine"    .s:fg_none        .s:bg_guide       .s:fmt_none
exe "hi! CursorLineNr"  .s:fg_magenta     .s:bg_guide       .s:fmt_none
...
exe "hi! StatusLineNC"  .s:fg_dim         .s:bg_guide       .s:fmt_none
