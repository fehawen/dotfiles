...
let s:gui.background = { 'dark': '#000F19', 'light': '#000F19' }
...
if !exists('g:nighthawk_style')
  let g:nighthawk_style='default'
endif
...
function! s:gui(color)
  if &background == "light"
    ...
    if g:nighthawk_style == 'default'
      return a:color['dark']
    else
      return a:color[g:nighthawk_style]
    endif
  endif
endfunction
