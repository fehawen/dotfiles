...
call s:hi("NERDTreeCWD",        s:gui.comment,    s:gui.none,     "italic")
...
" ALE COLORS
call s:hi("ALEInfoSign",         s:gui.magenta,   s:gui.none, "")
call s:hi("ALEErrorSign",        s:gui.magenta,   s:gui.none, "")
call s:hi("ALEWarningSign",      s:gui.magenta,   s:gui.none, "")
call s:hi("ALEStyleErrorSign",   s:gui.magenta,   s:gui.none, "")
call s:hi("ALEStyleWarningSign", s:gui.magenta,   s:gui.none, "")
...
call s:hi("typescriptIdentifier",                s:gui.yellow,      "", "bold")
call s:hi("typescriptStorageClass",              s:gui.blue,        "", "")
call s:hi("typescriptOperator",                  s:gui.blue,        "", "bold")
call s:hi("typescriptBoolean",                   s:gui.green,       "", "")
call s:hi("typescriptNull",                      s:gui.green,       "", "")
call s:hi("typescriptMessage",                   s:gui.green,       "", "")

call s:hi("typescriptConditional",               s:gui.green,       "", "italic")
call s:hi("typescriptRepeat",                    s:gui.green,       "", "italic")
call s:hi("typescriptBranch",                    s:gui.green,       "", "italic")
call s:hi("typescriptLabel",                     s:gui.blue,        "", "italic")
call s:hi("typescriptDecorators",                s:gui.blue,        "", "italic")
call s:hi("typescriptStatement",                 s:gui.green,       "", "")

call s:hi("typescriptGlobalObjects",             s:gui.blue,        "", "")
call s:hi("typescriptExceptions",                s:gui.green,       "", "bolditalic")
call s:hi("typescriptReserved",                  s:gui.red,         "", "")
call s:hi("typescriptVars",                      s:gui.green,       "", "")
call s:hi("typescriptParameters",                s:gui.green,       "", "")
call s:hi("typescriptType",                      s:gui.green,       "", "bold")
...
call s:hi("typescriptBraces",                    s:gui.magenta,     "", "")
call s:hi("typescriptParens",                    s:gui.magenta,     "", "")
call s:hi("typescriptOpSymbols",                 s:gui.magenta,     "", "")
call s:hi("typescriptEndColons",                 s:gui.magenta,     "", "")
...
" HTML colors
call s:hi("htmlTag",            s:gui.magenta, "", "")
call s:hi("htmlEndTag",         s:gui.magenta, "", "")
