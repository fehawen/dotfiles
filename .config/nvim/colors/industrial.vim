...
if has("nvim")
  ...
  let g:terminal_color_7  = s:gui(s:gui.orange)
...
call s:hi("Constant",    s:gui.orange,    "",               "", "", "")
call s:hi("Type",        s:gui.orange,     "",              "", "", "")
...
call s:hi("Identifier",  s:gui.orange,    "",               "", "", "")
