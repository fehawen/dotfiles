...
let s:gui.cursorline = { 'default': '#37474F' }
let s:gui.listchars  = { 'default': '#37474F' }
let s:gui.specialkey = { 'default': '#37474F' }
let s:gui.search     = { 'default': '#37474F' }
let s:gui.comment    = { 'default': '#37474F' }

let s:gui.black      = { 'default': '#37474F' }
let s:gui.red        = { 'default': '#F4511E' }
let s:gui.green      = { 'default': '#455A64' }
let s:gui.yellow     = { 'default': '#546E7A' }
let s:gui.blue       = { 'default': '#607D8B' }
let s:gui.magenta    = { 'default': '#78909C' }
